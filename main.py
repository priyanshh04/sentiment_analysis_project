"""
Main Training Script - UPDATED with proper plot generation
...
class SentimentAnalysisPipeline:
    """
    Complete sentiment analysis pipeline with FIXED plotting
    """
    ...
    def __init__(self, data_path: str = "data"):
        ...
        # Create directories - IMPORTANT: Include plots and reports directory
        ...
        Path("plots").mkdir(exist_ok=True)  # Ensure plots directory exists
    ...
    def load_data(self, filename: str = "Instruments_Reviews.csv") -> pd.DataFrame:
        ...
        # Print data summary using existing method
        print("\nDATA SUMMARY:")
        print("=" * 50)
    ...
    def evaluate_models(self) -> None:
        """Comprehensive model evaluation with FIXED plotting"""
        ...
        # Create evaluator with explicit plot directory
        ...
        if evaluation_results:
            ...
            roc_available = any('roc_curve' in results for results in evaluation_results.values())
            if roc_available:
        ...
        logger.info("Model evaluation completed with plots saved to 'plots/' directory")
